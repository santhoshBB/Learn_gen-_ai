def handle_small_talk(query: str, session_id: str) -> str:
    ...
    if any(g in query_lower for g in greetings):
        return "Hello! I'm your assistant for NodeJS, Business Correspondent, and PMJJBY queries. How can I help you today?"
    ...
    if "who are you" in query_lower or "what are you" in query_lower:
        return "I'm a specialized AI assistant for NodeJS, Business Correspondent (BC), and PMJJBY documentation."
    
    if "what can you do" in query_lower:
        return """I can help you with:
        1. NodeJS - JavaScript runtime, npm, async programming
        2. Business Correspondent - BC operations, eligibility
